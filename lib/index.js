...
Safe42.prototype.run = function () {
  this._onClickDigits(function(key) {
    ...
    this._settingsDisplayScreen.default.message = this._setEncodeCurrentPassword(this.currentPassword);
    this._renderDisplayScreen(this._settingsDisplayScreen.default);
...
Safe42.prototype._getAction = function (key) {
  ...
  var actions = {
    'enter': function () {
      ...
      this._renderDataConsole(this._getDataStorage(this.currentPassword));
      this.currentPassword = '';
